...
<form action="{{ url('post') }}" method="POST" class="p-2 ">
    ...
    <div class="p-2 flex-col">
      ...
      <div class="mt-4">
        ...
        <textarea name="content" class="bg-gray-200 border-2 border-gray-200 rounded w-1000 h-500 py-2 px-4 text-gray-700 focus:outline-none focus:bg-white focus:border-purple-500"></textarea>
      </div>
